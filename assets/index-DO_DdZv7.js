(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const p of c.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&r(p)}).observe(document,{childList:!0,subtree:!0});function n(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(s){if(s.ep)return;s.ep=!0;const c=n(s);fetch(s.href,c)}})();const L="https://cqxpjesovcavarrlljpn.supabase.co",b="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNxeHBqZXNvdmNhdmFycmxsanBuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI0NjI4MjYsImV4cCI6MjA4ODAzODgyNn0._paXbtV1uecR0AA08KUkKLfRkmkQw2k4W3hT5L2y2ho";async function U(){const e=await fetch(`${L}/rest/v1/manual_events?select=*&order=date.asc`,{headers:{apikey:b,Authorization:"Bearer "+b}});return e.ok?(await e.json()).map(n=>({id:n.id,title:n.title,type:n.type,date:n.date,time:n.time,locationId:n.location_id,locationName:n.location_name,locationCity:n.location_city,description:n.description,ticketUrl:n.ticket_url,spotifyUrl:n.spotify_url,source:"manual"})):[]}async function K(e,t,n){return(await fetch(`${L}/rest/v1/manual_events`,{method:"POST",headers:{apikey:b,Authorization:"Bearer "+b,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({id:e.id,title:e.title,type:e.type,date:e.date,time:e.time,location_id:e.locationId,location_name:t,location_city:n,description:e.description,ticket_url:e.ticketUrl,spotify_url:e.spotifyUrl})})).ok}async function F(){const e=new Date().toISOString().split("T")[0];await fetch(`${L}/rest/v1/manual_events?date=lt.${e}`,{method:"DELETE",headers:{apikey:b,Authorization:"Bearer "+b}})}async function J(){const e=await fetch(`${L}/rest/v1/bookmarks?select=*`,{headers:{apikey:b,Authorization:"Bearer "+b}});if(!e.ok)return{bookmarked:[],going:[]};const t=await e.json();return{bookmarked:t.filter(n=>n.status==="bookmarked").map(n=>n.event_id),going:t.filter(n=>n.status==="going").map(n=>n.event_id)}}async function C(e,t){return(await(await fetch(`${L}/rest/v1/bookmarks?event_id=eq.${e}&status=eq.${t}`,{headers:{apikey:b,Authorization:"Bearer "+b}})).json()).length>0?(await fetch(`${L}/rest/v1/bookmarks?event_id=eq.${e}&status=eq.${t}`,{method:"DELETE",headers:{apikey:b,Authorization:"Bearer "+b}}),!1):(await fetch(`${L}/rest/v1/bookmarks`,{method:"POST",headers:{apikey:b,Authorization:"Bearer "+b,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({event_id:String(e),status:t})}),!0)}function D(e){const t=localStorage.getItem(e);return t?JSON.parse(t):null}function B(e,t){localStorage.setItem(e,JSON.stringify(t))}function W(){const e=D("locations");if(e)return e;const t=[{id:1,name:"Lido",city:"Berlin",website:"lido-berlin.de",capacity:400},{id:2,name:"SO36",city:"Berlin",website:"so36.com",capacity:600},{id:3,name:"Festsaal Kreuzberg",city:"Berlin",website:"festsaal-kreuzberg.de",capacity:1200},{id:4,name:"Privatclub",city:"Berlin",website:"privatclub-berlin.de",capacity:250},{id:5,name:"Astra Kulturhaus",city:"Berlin",website:"astra-berlin.de",capacity:1800},{id:6,name:"Frannz Club",city:"Berlin",website:"frannz.eu",capacity:350},{id:7,name:"Monarch",city:"Berlin",website:"kottimonarch.de",capacity:150},{id:8,name:"Musik & Frieden",city:"Berlin",website:"musikundfrieden.de",capacity:700},{id:9,name:"Wild at Heart",city:"Berlin",website:"wildatheartberlin.de",capacity:280},{id:10,name:"Columbia Theater",city:"Berlin",website:"columbia-theater.de",capacity:800},{id:11,name:"Schokoladen",city:"Berlin",website:"schokoladen-mitte.de",capacity:150},{id:12,name:"Madame Claude",city:"Berlin",website:"madameclaude.de",capacity:100},{id:13,name:"Conne Island",city:"Leipzig",website:"conne-island.de",capacity:600},{id:14,name:"Werk 2",city:"Leipzig",website:"werk-2.de",capacity:500},{id:15,name:"Täubchenthal",city:"Leipzig",website:"taeubchenthal.com",capacity:1200},{id:16,name:"Felsenkeller",city:"Leipzig",website:"felsenkeller-leipzig.com",capacity:2e3},{id:17,name:"UT Connewitz",city:"Leipzig",website:"utconnewitz.de",capacity:350},{id:18,name:"Moritzbastei",city:"Leipzig",website:"moritzbastei.de",capacity:500},{id:19,name:"Horns Erben",city:"Leipzig",website:"horns-erben.de",capacity:150},{id:20,name:"Ilses Erika",city:"Leipzig",website:"",capacity:200},{id:21,name:"Urban Spree",city:"Berlin",website:"urbanspree.com",capacity:250},{id:22,name:"Gretchen",city:"Berlin",website:"gretchen-club.de",capacity:500},{id:23,name:"Supamolly",city:"Berlin",website:"supamolly.de",capacity:150},{id:24,name:"Kantine am Berghain",city:"Berlin",website:"berghain.berlin",capacity:200},{id:25,name:"Tempodrom",city:"Berlin",website:"tempodrom.de",capacity:4200},{id:26,name:"Heimathafen Neukölln",city:"Berlin",website:"heimathafen-neukoelln.de",capacity:450},{id:27,name:"Bi Nuu",city:"Berlin",website:"binuu.de",capacity:400},{id:28,name:"Mikropol",city:"Berlin",website:"mikropol-berlin.de",capacity:300}];return B("locations",t),t}async function A(){try{const e=await fetch("./events.json"),t=e.ok?await e.json():[],n=await U();return[...t,...n]}catch(e){return console.log("Fehler beim Laden:",e),[]}}let v=W(),E=[],q=null,l={cities:["Berlin","Leipzig"],type:"alle",locationId:"alle",dates:[]},f=D("bookmarked")||[],w=D("going")||[],N=D("seenEvents")||[],$="liste",j=0;async function Y(e){q=e,E=await A();const t=await J();f=t.bookmarked,w=t.going,g()}function O(e){return!N.includes(e.id)}function H(){N=E.map(e=>e.id),B("seenEvents",N)}function g(){const e=E.filter(t=>O(t)).length;q.innerHTML=`
  ...
  `}function V(){return`
    <div class="flex gap-1.5 mb-6 p-1 rounded-2xl glass">
      ${[{id:"liste",label:"Events"},{id:"kalender",label:"Kalender"},{id:"gemerkt",label:`Gemerkt${f.length+w.length>0?" · "+(f.length+w.length):""}`}].map(t=>`
  ...
  `}function T(){const e=v.filter(t=>l.cities.includes(t.city)).sort((t,n)=>t.name.localeCompare(n.name));return`
    <div class="glass rounded-2xl p-4 mb-5 space-y-3">
      ...
      <div style="position:relative;">
        <div id="filter-loc-selected" style="cursor:pointer; padding:10px 14px; border-radius:12px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); display:flex; justify-content:space-between; align-items:center;">
          <span style="font-size:14px; color:rgba(255,255,255,0.5);">${l.locationId==="alle"?"Alle Locations":v.find(t=>t.id==l.locationId)?.name||"Alle Locations"}</span>
  ...
  `}function P(){return E.filter(e=>{const t=v.find(r=>r.id===e.locationId),n=t?t.city:e.locationCity||"";return n?!(!l.cities.includes(n)||l.type!=="alle"&&e.type!==l.type||l.locationId!=="alle"&&e.locationId!=l.locationId):!0}).sort((e,t)=>new Date(e.date+"T"+e.time)-new Date(t.date+"T"+t.time))}function X(){const e=P(),t=new Date;t.setHours(0,0,0,0);const n={};return e.forEach(r=>{const s=new Date(r.date+"T12:00:00"),c=Math.floor((s-t)/864e5);let p;const y=t.getDay()===0?6:t.getDay()-1,m=new Date(t);m.setDate(t.getDate()-y);const x=new Date(m);x.setDate(m.getDate()+7);const u=new Date(x);u.setDate(x.getDate()+7),c===0?p="Heute":c===1?p="Morgen":s<x?p="Diese Woche":s<u?p="Nächste Woche":p=s.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),n[p]||(n[p]=[]),n[p].push(r)}),Object.keys(n).length===0?`${T()}<div class="text-center py-20 text-slate-600"><p class="syne text-2xl mb-2">—</p><p class="text-sm">Keine Events gefunden.</p></div>`:`
    ${T()}
    <div class="space-y-8">
      ${Object.entries(n).map(([r,s])=>`
        <div>
          ...
          <div class="space-y-3">${s.map(c=>_(c)).join("")}</div>
        </div>
      `).join("")}
    </div>
  `}function _(e){const t=v.find(u=>u.id===e.locationId),n=f.includes(e.id),r=w.includes(e.id),s=O(e),p=new Date(e.date+"T12:00:00").toLocaleDateString("de-DE",{weekday:"short",day:"numeric",month:"short"}),y=e.type==="konzert",m=y?"#818cf8":"#fb923c";return`
        ...
        <div class="flex justify-between items-start gap-3">
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-2 flex-wrap">
              <span class="syne text-xs" style="color:${m}; font-weight:700;">${p} · ${e.time}</span>
  ...
  `}function Z(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth()+j,1),n=t.getFullYear(),r=t.getMonth(),s=new Date(n,r+1,0).getDate(),c=(new Date(n,r,1).getDay()+6)%7,p=t.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),y=P(),m=y.map(u=>u.date),x=y.filter(u=>l.dates.length===0||l.dates.includes(u.date));return`
    ${T()}
    <div class="glass rounded-2xl p-5 mb-5">
      ...
      <div class="grid grid-cols-7 gap-1 text-center mb-3">
        ${["Mo","Di","Mi","Do","Fr","Sa","So"].map(u=>`<div class="text-xs font-semibold py-1" style="color:rgba(255,255,255,0.2);">${u}</div>`).join("")}
      </div>
      <div class="grid grid-cols-7 gap-1">
        ${Array(c).fill("<div></div>").join("")}
        ${Array.from({length:s},(u,i)=>{const a=i+1,o=`${n}-${String(r+1).padStart(2,"0")}-${String(a).padStart(2,"0")}`,d=m.includes(o),h=l.dates.includes(o),z=a===e.getDate()&&r===e.getMonth()&&n===e.getFullYear(),S=new Date(o)<e&&!z;return`
            <button data-date="${o}" style="aspect-ratio:1; border-radius:12px; font-size:14px; font-weight:500; display:flex; align-items:center; justify-content:center; position:relative; transition:all 0.15s; ${S?"opacity:0.25;":""} color:${!d&&!h&&!z?"rgba(255,255,255,0.2)":"white"}; background:${h?"rgba(99,102,241,0.5)":d?"rgba(99,102,241,0.12)":"transparent"}; border:${h?"1px solid rgba(99,102,241,0.6)":d?"1px solid rgba(99,102,241,0.25)":z?"1px solid rgba(255,255,255,0.2)":"1px solid transparent"}; padding:4px; cursor:pointer;">
              ${a}
              ${d&&!h?'<span style="position:absolute;bottom:3px;left:50%;transform:translateX(-50%);width:3px;height:3px;border-radius:50%;background:#818cf8;"></span>':""}
            </button>
          `}).join("")}
      </div>
      ${l.dates.length>0?`
    ...
    <div class="space-y-3">
      ${l.dates.length>0&&x.length===0?'<p class="text-center text-slate-600 py-6 text-sm">Keine Events an den gewählten Tagen.</p>':x.map(u=>_(u)).join("")}
    </div>
  `}function G(){const e=E.filter(r=>f.includes(r.id)&&!w.includes(r.id)),n=[...E.filter(r=>w.includes(r.id)).map(r=>({...r,_status:"dabei"})),...e.map(r=>({...r,_status:"gemerkt"}))].sort((r,s)=>new Date(r.date+"T"+r.time)-new Date(s.date+"T"+s.time));return n.length===0?`
  ...
  `}const k="width:100%; border-radius:12px; padding:10px 14px; font-size:14px; color:white; outline:none; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1); font-family:'DM Sans',sans-serif; color-scheme:dark;";function Q(){const e=v.slice().sort((t,n)=>t.name.localeCompare(n.name));return`

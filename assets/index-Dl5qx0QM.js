(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const d of s)if(d.type==="childList")for(const c of d.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(s){const d={};return s.integrity&&(d.integrity=s.integrity),s.referrerPolicy&&(d.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?d.credentials="include":s.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(s){if(s.ep)return;s.ep=!0;const d=n(s);fetch(s.href,d)}})();const N="https://cqxpjesovcavarrlljpn.supabase.co",I="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNxeHBqZXNvdmNhdmFycmxsanBuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI0NjI4MjYsImV4cCI6MjA4ODAzODgyNn0._paXbtV1uecR0AA08KUkKLfRkmkQw2k4W3hT5L2y2ho";async function _(){const e=await fetch(`${N}/rest/v1/manual_events?select=*&order=date.asc`,{headers:{apikey:I,Authorization:"Bearer "+I}});return e.ok?(await e.json()).map(n=>({id:n.id,title:n.title,type:n.type,date:n.date,time:n.time,locationId:n.location_id,locationName:n.location_name,locationCity:n.location_city,description:n.description,ticketUrl:n.ticket_url,spotifyUrl:n.spotify_url,source:"manual"})):[]}async function U(e,t,n){return(await fetch(`${N}/rest/v1/manual_events`,{method:"POST",headers:{apikey:I,Authorization:"Bearer "+I,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({id:e.id,title:e.title,type:e.type,date:e.date,time:e.time,location_id:e.locationId,location_name:t,location_city:n,description:e.description,ticket_url:e.ticketUrl,spotify_url:e.spotifyUrl})})).ok}async function q(){const e=new Date().toISOString().split("T")[0];await fetch(`${N}/rest/v1/manual_events?date=lt.${e}`,{method:"DELETE",headers:{apikey:I,Authorization:"Bearer "+I}})}function S(e){const t=localStorage.getItem(e);return t?JSON.parse(t):null}function $(e,t){localStorage.setItem(e,JSON.stringify(t))}function P(){const e=S("locations");if(e)return e;const t=[{id:1,name:"Lido",city:"Berlin",website:"lido-berlin.de",capacity:400},{id:2,name:"SO36",city:"Berlin",website:"so36.com",capacity:600},{id:3,name:"Festsaal Kreuzberg",city:"Berlin",website:"festsaal-kreuzberg.de",capacity:1200},{id:4,name:"Privatclub",city:"Berlin",website:"privatclub-berlin.de",capacity:250},{id:5,name:"Astra Kulturhaus",city:"Berlin",website:"astra-berlin.de",capacity:1800},{id:6,name:"Frannz Club",city:"Berlin",website:"frannz.eu",capacity:350},{id:7,name:"Monarch",city:"Berlin",website:"kottimonarch.de",capacity:150},{id:8,name:"Musik & Frieden",city:"Berlin",website:"musikundfrieden.de",capacity:700},{id:9,name:"Wild at Heart",city:"Berlin",website:"wildatheartberlin.de",capacity:280},{id:10,name:"Columbia Theater",city:"Berlin",website:"columbia-theater.de",capacity:800},{id:11,name:"Schokoladen",city:"Berlin",website:"schokoladen-mitte.de",capacity:150},{id:12,name:"Madame Claude",city:"Berlin",website:"madameclaude.de",capacity:100},{id:13,name:"Conne Island",city:"Leipzig",website:"conne-island.de",capacity:600},{id:14,name:"Werk 2",city:"Leipzig",website:"werk-2.de",capacity:500},{id:15,name:"Täubchenthal",city:"Leipzig",website:"taeubchenthal.com",capacity:1200},{id:16,name:"Felsenkeller",city:"Leipzig",website:"felsenkeller-leipzig.com",capacity:2e3},{id:17,name:"UT Connewitz",city:"Leipzig",website:"utconnewitz.de",capacity:350},{id:18,name:"Moritzbastei",city:"Leipzig",website:"moritzbastei.de",capacity:500},{id:19,name:"Horns Erben",city:"Leipzig",website:"horns-erben.de",capacity:150},{id:20,name:"Ilses Erika",city:"Leipzig",website:"",capacity:200},{id:21,name:"Urban Spree",city:"Berlin",website:"urbanspree.com",capacity:250},{id:22,name:"Gretchen",city:"Berlin",website:"gretchen-club.de",capacity:500},{id:23,name:"Supamolly",city:"Berlin",website:"supamolly.de",capacity:150},{id:24,name:"Kantine am Berghain",city:"Berlin",website:"berghain.berlin",capacity:200},{id:25,name:"Tempodrom",city:"Berlin",website:"tempodrom.de",capacity:4200},{id:26,name:"Heimathafen Neukölln",city:"Berlin",website:"heimathafen-neukoelln.de",capacity:450},{id:27,name:"Bi Nuu",city:"Berlin",website:"binuu.de",capacity:400},{id:28,name:"Mikropol",city:"Berlin",website:"mikropol-berlin.de",capacity:300}];return $("locations",t),t}async function z(){try{const e=await fetch("./events.json"),t=e.ok?await e.json():[],n=await _();return[...t,...n]}catch(e){return console.log("Fehler beim Laden:",e),[]}}let b=P(),m=[],j=null,l={cities:["Berlin","Leipzig"],type:"alle",locationId:"alle",dates:[]},x=S("bookmarked")||[],w=S("going")||[],B=S("seenEvents")||[],k="liste",D=0;async function R(e){j=e,m=await z(),u()}function C(e){return!B.includes(e.id)}function K(){B=m.map(e=>e.id),$("seenEvents",B)}function u(){const e=m.filter(t=>C(t)).length;j.innerHTML=`
  ...
  `}function A(){const e=b.filter(t=>l.cities.includes(t.city)).sort((t,n)=>t.name.localeCompare(n.name));return`
  ...
  `}function M(){return m.filter(e=>{const t=b.find(r=>r.id===e.locationId),n=t?t.city:e.locationCity||"";return n?!(!l.cities.includes(n)||l.type!=="alle"&&e.type!==l.type||l.locationId!=="alle"&&e.locationId!=l.locationId):!0}).sort((e,t)=>new Date(e.date+"T"+e.time)-new Date(t.date+"T"+t.time))}function Y(){const e=M(),t=new Date;t.setHours(0,0,0,0);const n={};return e.forEach(r=>{const s=new Date(r.date+"T12:00:00"),d=Math.floor((s-t)/864e5);let c;d===0?c="Heute":d===1?c="Morgen":d<=7?c="Diese Woche":d<=14?c="Nächste Woche":c=s.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),n[c]||(n[c]=[]),n[c].push(r)}),Object.keys(n).length===0?`${A()}<div class="text-center py-20 text-slate-600"><p class="syne text-2xl mb-2">—</p><p class="text-sm">Keine Events gefunden.</p></div>`:`
    ${A()}
    <div class="space-y-8">
  ...
  `}function T(e){const t=b.find(i=>i.id===e.locationId),n=x.includes(e.id),r=w.includes(e.id),s=C(e),c=new Date(e.date+"T12:00:00").toLocaleDateString("de-DE",{weekday:"short",day:"numeric",month:"short"}),g=e.type==="konzert",y=g?"#818cf8":"#fb923c";return`
    <div class="card-hover rounded-2xl overflow-hidden" style="background:rgba(8,8,42,0.92); border:1px solid ${r?"rgba(52,211,153,0.3)":(g?"rgba(99,102,241,":"rgba(251,146,60,")+"0.12)"}; box-shadow:0 4px 24px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.05);">
  ...
  `}function W(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth()+D,1),n=t.getFullYear(),r=t.getMonth(),s=new Date(n,r+1,0).getDate(),d=(new Date(n,r,1).getDay()+6)%7,c=t.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),g=M(),y=g.map(i=>i.date),a=g.filter(i=>l.dates.length===0||l.dates.includes(i.date));return`
    ${A()}
    <div class="glass rounded-2xl p-5 mb-5">
      ...
      <div class="grid grid-cols-7 gap-1">
        ...
        ${Array.from({length:s},(i,o)=>{const p=o+1,E=`${n}-${String(r+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`,v=y.includes(E),f=l.dates.includes(E),L=p===e.getDate()&&r===e.getMonth()&&n===e.getFullYear(),O=new Date(E)<e&&!L;return`
            <button data-date="${E}" style="aspect-ratio:1; border-radius:12px; font-size:14px; font-weight:500; display:flex; align-items:center; justify-content:center; position:relative; transition:all 0.15s; ${O?"opacity:0.25;":""} color:${!v&&!f&&!L?"rgba(255,255,255,0.2)":"white"}; background:${f?"rgba(99,102,241,0.5)":v?"rgba(99,102,241,0.12)":"transparent"}; border:${f?"1px solid rgba(99,102,241,0.6)":v?"1px solid rgba(99,102,241,0.25)":L?"1px solid rgba(255,255,255,0.2)":"1px solid transparent"}; padding:4px; cursor:pointer;">
              ${p}
              ${v&&!f?'<span style="position:absolute;bottom:3px;left:50%;transform:translateX(-50%);width:3px;height:3px;border-radius:50%;background:#818cf8;"></span>':""}
            </button>
          `}).join("")}
      </div>
      ${l.dates.length>0?`
  ...
  `}function H(){const e=m.filter(r=>x.includes(r.id)),t=m.filter(r=>w.includes(r.id)),n=(r,s,d)=>`
    <div>
      <div class="flex items-center gap-3 mb-4">
        <div class="h-px flex-1" style="background:rgba(255,255,255,0.06);"></div>
        <span class="syne text-xs tracking-widest uppercase" style="color:rgba(255,255,255,0.25); font-weight:700;">${r}</span>
  ...
  `}const h="width:100%; border-radius:12px; padding:10px 14px; font-size:14px; color:white; outline:none; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1); font-family:'DM Sans',sans-serif; color-scheme:dark;";function J(){const e=b.slice().sort((t,n)=>t.name.localeCompare(n.name));return`

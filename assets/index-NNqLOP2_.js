(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))l(s);new MutationObserver(s=>{for(const d of s)if(d.type==="childList")for(const c of d.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function n(s){const d={};return s.integrity&&(d.integrity=s.integrity),s.referrerPolicy&&(d.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?d.credentials="include":s.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function l(s){if(s.ep)return;s.ep=!0;const d=n(s);fetch(s.href,d)}})();const T="https://cqxpjesovcavarrlljpn.supabase.co",I="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNxeHBqZXNvdmNhdmFycmxsanBuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI0NjI4MjYsImV4cCI6MjA4ODAzODgyNn0._paXbtV1uecR0AA08KUkKLfRkmkQw2k4W3hT5L2y2ho";async function _(){const e=await fetch(`${T}/rest/v1/manual_events?select=*&order=date.asc`,{headers:{apikey:I,Authorization:"Bearer "+I}});return e.ok?(await e.json()).map(n=>({id:n.id,title:n.title,type:n.type,date:n.date,time:n.time,locationId:n.location_id,locationName:n.location_name,locationCity:n.location_city,description:n.description,ticketUrl:n.ticket_url,spotifyUrl:n.spotify_url,source:"manual"})):[]}async function U(e,t,n){return(await fetch(`${T}/rest/v1/manual_events`,{method:"POST",headers:{apikey:I,Authorization:"Bearer "+I,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({id:e.id,title:e.title,type:e.type,date:e.date,time:e.time,location_id:e.locationId,location_name:t,location_city:n,description:e.description,ticket_url:e.ticketUrl,spotify_url:e.spotifyUrl})})).ok}async function q(){const e=new Date().toISOString().split("T")[0];await fetch(`${T}/rest/v1/manual_events?date=lt.${e}`,{method:"DELETE",headers:{apikey:I,Authorization:"Bearer "+I}})}function z(e){const t=localStorage.getItem(e);return t?JSON.parse(t):null}function L(e,t){localStorage.setItem(e,JSON.stringify(t))}function P(){const e=z("locations");if(e)return e;const t=[{id:1,name:"Lido",city:"Berlin",website:"lido-berlin.de",capacity:400},{id:2,name:"SO36",city:"Berlin",website:"so36.com",capacity:600},{id:3,name:"Festsaal Kreuzberg",city:"Berlin",website:"festsaal-kreuzberg.de",capacity:1200},{id:4,name:"Privatclub",city:"Berlin",website:"privatclub-berlin.de",capacity:250},{id:5,name:"Astra Kulturhaus",city:"Berlin",website:"astra-berlin.de",capacity:1800},{id:6,name:"Frannz Club",city:"Berlin",website:"frannz.eu",capacity:350},{id:7,name:"Monarch",city:"Berlin",website:"kottimonarch.de",capacity:150},{id:8,name:"Musik & Frieden",city:"Berlin",website:"musikundfrieden.de",capacity:700},{id:9,name:"Wild at Heart",city:"Berlin",website:"wildatheartberlin.de",capacity:280},{id:10,name:"Columbia Theater",city:"Berlin",website:"columbia-theater.de",capacity:800},{id:11,name:"Schokoladen",city:"Berlin",website:"schokoladen-mitte.de",capacity:150},{id:12,name:"Madame Claude",city:"Berlin",website:"madameclaude.de",capacity:100},{id:13,name:"Conne Island",city:"Leipzig",website:"conne-island.de",capacity:600},{id:14,name:"Werk 2",city:"Leipzig",website:"werk-2.de",capacity:500},{id:15,name:"Täubchenthal",city:"Leipzig",website:"taeubchenthal.com",capacity:1200},{id:16,name:"Felsenkeller",city:"Leipzig",website:"felsenkeller-leipzig.com",capacity:2e3},{id:17,name:"UT Connewitz",city:"Leipzig",website:"utconnewitz.de",capacity:350},{id:18,name:"Moritzbastei",city:"Leipzig",website:"moritzbastei.de",capacity:500},{id:19,name:"Horns Erben",city:"Leipzig",website:"horns-erben.de",capacity:150},{id:20,name:"Ilses Erika",city:"Leipzig",website:"",capacity:200},{id:21,name:"Urban Spree",city:"Berlin",website:"urbanspree.com",capacity:250},{id:22,name:"Gretchen",city:"Berlin",website:"gretchen-club.de",capacity:500},{id:23,name:"Supamolly",city:"Berlin",website:"supamolly.de",capacity:150},{id:24,name:"Kantine am Berghain",city:"Berlin",website:"berghain.berlin",capacity:200},{id:25,name:"Tempodrom",city:"Berlin",website:"tempodrom.de",capacity:4200},{id:26,name:"Heimathafen Neukölln",city:"Berlin",website:"heimathafen-neukoelln.de",capacity:450},{id:27,name:"Bi Nuu",city:"Berlin",website:"binuu.de",capacity:400},{id:28,name:"Mikropol",city:"Berlin",website:"mikropol-berlin.de",capacity:300}];return L("locations",t),t}async function B(){try{const e=await fetch("./events.json"),t=e.ok?await e.json():[],n=await _();return[...t,...n]}catch(e){return console.log("Fehler beim Laden:",e),[]}}let b=P(),x=[],C=null,r={cities:["Berlin","Leipzig"],type:"alle",locationId:"alle",dates:[]},h=z("bookmarked")||[],k=z("going")||[],D=z("seenEvents")||[],E="liste",A=0;async function R(e){C=e,x=await B(),u()}function M(e){return!D.includes(e.id)}function K(){D=x.map(e=>e.id),L("seenEvents",D)}function u(){const e=x.filter(t=>M(t)).length;C.innerHTML=`
  <div id="ptr-indicator" style="text-align:center; height:0; overflow:hidden; transition:height 0.2s; color:rgba(255,255,255,0.5); font-size:13px; display:flex; align-items:center; justify-content:center;">↻ Aktualisieren...</div>
    ...
    ${H()}
  `,Z(),e>0&&E==="liste"&&setTimeout(()=>K(),3e3)}function V(e){return`
  ...
  `}function N(){const e=b.filter(t=>r.cities.includes(t.city)).sort((t,n)=>t.name.localeCompare(n.name));return`
  ...
  `}function O(){return x.filter(e=>{const t=b.find(l=>l.id===e.locationId),n=t?t.city:e.locationCity||"";return n?!(!r.cities.includes(n)||r.type!=="alle"&&e.type!==r.type||r.locationId!=="alle"&&e.locationId!=r.locationId):!0}).sort((e,t)=>new Date(e.date+"T"+e.time)-new Date(t.date+"T"+t.time))}function J(){const e=O(),t=new Date;t.setHours(0,0,0,0);const n={};return e.forEach(l=>{const s=new Date(l.date+"T12:00:00"),d=Math.floor((s-t)/864e5);let c;d===0?c="Heute":d===1?c="Morgen":d<=7?c="Diese Woche":d<=14?c="Nächste Woche":c=s.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),n[c]||(n[c]=[]),n[c].push(l)}),Object.keys(n).length===0?`${N()}<div class="text-center py-20 text-slate-600"><p class="syne text-2xl mb-2">—</p><p class="text-sm">Keine Events gefunden.</p></div>`:`
    ${N()}
    <div class="space-y-8">
      ${Object.entries(n).map(([l,s])=>`
        <div>
          ...
          <div class="space-y-3">${s.map(d=>j(d)).join("")}</div>
        </div>
      `).join("")}
    </div>
  `}function j(e){const t=b.find(i=>i.id===e.locationId),n=h.includes(e.id),l=k.includes(e.id),s=M(e),c=new Date(e.date+"T12:00:00").toLocaleDateString("de-DE",{weekday:"short",day:"numeric",month:"short"}),g=e.type==="konzert",y=g?"#818cf8":"#fb923c";return`
  ...
  `}function Y(){const e=new Date,t=new Date(e.getFullYear(),e.getMonth()+A,1),n=t.getFullYear(),l=t.getMonth(),s=new Date(n,l+1,0).getDate(),d=(new Date(n,l,1).getDay()+6)%7,c=t.toLocaleDateString("de-DE",{month:"long",year:"numeric"}),g=O(),y=g.map(i=>i.date),a=g.filter(i=>r.dates.length===0||r.dates.includes(i.date));return`
    ${N()}
    <div class="glass rounded-2xl p-5 mb-5">
      ...
      <div class="grid grid-cols-7 gap-1">
        ...
        ${Array.from({length:s},(i,o)=>{const p=o+1,m=`${n}-${String(l+1).padStart(2,"0")}-${String(p).padStart(2,"0")}`,$=y.includes(m),w=r.dates.includes(m),v=p===e.getDate()&&l===e.getMonth()&&n===e.getFullYear(),S=new Date(m)<e&&!v;return`
            <button data-date="${m}" style="aspect-ratio:1; border-radius:12px; font-size:14px; font-weight:500; display:flex; align-items:center; justify-content:center; position:relative; transition:all 0.15s; ${S?"opacity:0.25;":""} color:${!$&&!w&&!v?"rgba(255,255,255,0.2)":"white"}; background:${w?"rgba(99,102,241,0.5)":$?"rgba(99,102,241,0.12)":"transparent"}; border:${w?"1px solid rgba(99,102,241,0.6)":$?"1px solid rgba(99,102,241,0.25)":v?"1px solid rgba(255,255,255,0.2)":"1px solid transparent"}; padding:4px; cursor:pointer;">
              ${p}
    ...
    <div class="space-y-3">
      ${r.dates.length>0&&a.length===0?'<p class="text-center text-slate-600 py-6 text-sm">Keine Events an den gewählten Tagen.</p>':a.map(i=>j(i)).join("")}
    </div>
  `}function W(){const e=x.filter(l=>h.includes(l.id)),t=x.filter(l=>k.includes(l.id)),n=(l,s,d)=>`
    <div>
      <div class="flex items-center gap-3 mb-4">
        <div class="h-px flex-1" style="background:rgba(255,255,255,0.06);"></div>
        <span class="syne text-xs tracking-widest uppercase" style="color:rgba(255,255,255,0.25); font-weight:700;">${l}</span>
      ...
      ${s.length===0?`<p class="text-slate-700 text-sm py-4 text-center">${d}</p>`:`<div class="space-y-3">${s.map(c=>j(c)).join("")}</div>`}
    </div>
  `;return`
  ...
  `}const f="width:100%; border-radius:12px; padding:10px 14px; font-size:14px; color:white; outline:none; background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1); font-family:'DM Sans',sans-serif; color-scheme:dark;";function H(){const e=b.slice().sort((t,n)=>t.name.localeCompare(n.name));return`
      ...
      <div class="max-w-lg mx-auto mt-8 mb-12 mx-4 rounded-3xl overflow-hidden" style="background:rgba(12,17,32,0.97); border:1px solid rgba(255,255,255,0.1); box-shadow:0 24px 80px rgba(0,0,0,0.6);">
        ...
        <div class="p-6">
          ...
          <div id="add-event-form">
            <div class="space-y-3">
              <input id="new-title" type="text" placeholder="Titel (z.B. Bandname – Releaseshow)" style="${f}" />
              <div class="flex gap-2">
              ...
              <div class="flex gap-2">
                <input id="new-date" type="text" placeholder="TT.MM.JJJJ" style="${f} flex:1;" />
                <input id="new-time" type="text" placeholder="HH:MM" style="${f} flex:1;" />
              </div>
              <div style="position:relative;">
              ...
              <div id="new-location-custom" class="hidden space-y-2">
                <input id="new-location-name" type="text" placeholder="Name der neuen Location" style="${f}" />
                <div class="flex gap-2">
              ...
              <textarea id="new-desc" placeholder="Kurzbeschreibung: Wer? Woher? Musikrichtung?" style="${f} height:70px; resize:none;"></textarea>
              <input id="new-ticket" type="url" placeholder="Ticket-URL (optional)" style="${f}" />
              <input id="new-spotify" type="url" placeholder="Spotify-Link (optional)" style="${f}" />
          ...
          <div id="add-location-form" class="hidden">
            <div class="space-y-3">
              <input id="new-loc-name" type="text" placeholder="Name der Location" style="${f}" />
              <div class="flex gap-2">
              ...
              <input id="new-loc-website" type="url" placeholder="Website (optional)" style="${f}" />
              <input id="new-loc-capacity" type="number" placeholder="Kapazität (optional)" style="${f}" />

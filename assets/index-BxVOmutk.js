  ...
  `,Z(),e>0&&k==="liste"&&setTimeout(()=>K(),3e3)}function V(e){return`
    <div class="pt-10 pb-6">
      <div class="flex items-center justify-between gap-2">
        ...
        ${e>0?`<div style="flex-shrink:0; width:60px; height:60px; border-radius:50%; background:rgba(244,114,182,0.15); border:1px solid rgba(244,114,182,0.25); color:#f472b6; display:flex; flex-direction:column; align-items:center; justify-content:center; line-height:1.2;">

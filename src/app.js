  ...
  return `
    <div class="pt-10 pb-6">
      <div class="flex items-center justify-between gap-3">
        ...
        ${newCount > 0 ? `<span class="text-xs font-semibold px-3 py-1.5 rounded-full flex-shrink-0" style="background: rgba(244,114,182,0.15); border: 1px solid rgba(244,114,182,0.25); color: #f472b6;">${newCount} neu</span>` : ''}
